...
interface IMechMarketplace {
    ...
    function request(bytes memory data, uint256 priorityMechServiceId, uint256 responseTimeout,
        bytes memory paymentData) external payable returns (uint256);
}
