...
import {MechFixedPriceTokenUSDC} from "./MechFixedPriceTokenUSDC.sol";

/// @title MechFactoryFixedPriceToken - Periphery smart contract for managing fixed price token mech creation
contract MechFactoryFixedPriceTokenUSDC is MechFactoryBase {
    ...
    function _createMechWithSalt(
        ...
        mech = address((new MechFixedPriceTokenUSDC){salt: salt}(mechMarketplace, serviceRegistry, serviceId, maxDeliveryRate));
    }
}
